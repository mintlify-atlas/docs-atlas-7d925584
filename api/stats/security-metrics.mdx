...
```bash
curl -X GET "https://api.securelink.com/api/stats/security/exceptions?limit=10" \
...
```bash
curl -X GET "https://api.securelink.com/api/stats/links" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://api.securelink.com/api/stats/links/top?limit=20" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
